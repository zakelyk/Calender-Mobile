...
void main() {
  Get.put(NoteController()); // Inisialisasi controller
  runApp(MyApp());
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.calendar_today), // Simbol 📅
            onPressed: () {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          _showNoteForm(context);
        },
        child: Icon(Icons.add),
        backgroundColor: Colors.green,
      ),
      body: DefaultTabController(
        length: 3, // Menambahkan tab notifikasi hari libur
        child: Column(
          children: <Widget>[
            Container(
                ...
                child: TableCalendar(
                  ...
                  calendarStyle: CalendarStyle(
                    ...
                    weekendTextStyle: TextStyle(
                      color: Colors.red, // Warna merah untuk hari Minggu
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Obx(() {
                      return _noteControllerGetX.notes.isEmpty
                          ? Center(
                        child: Text(
                          'Nothing Here, Please fill Your Plan/Schedule',
                          style: TextStyle(
                            fontSize: 13.0,
                          ...
                          : ListView.builder(
                        itemCount: _noteControllerGetX.notes.length,
